...
open class FrontOfficeAPI {
    ...
    /**
     ...
     - parameter userInteractionRequest: (body)  (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func documentInteraction(userId: String, userInteractionRequest: UserInteractionRequest? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
        return documentInteractionWithRequestBuilder(userId: userId, userInteractionRequest: userInteractionRequest).execute(apiResponseQueue) { result in
            switch result {
            case .success:
                completion((), nil)
     ...
     */
    open class func documentInteractionWithRequestBuilder(userId: String, userInteractionRequest: UserInteractionRequest? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    open class func getPersonalizedDocuments(userId: String, count: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: PersonalizedDocumentsResponse?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getPersonalizedDocumentsWithRequestBuilder(userId: String, count: Int? = nil) -> RequestBuilder<PersonalizedDocumentsResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PersonalizedDocumentsResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
